                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        @foreach ($admin_users as $user)
                            <tr>
                                <th>
                                    <a href="#" class="btn btn-sm btn-warning"><i class="fa-solid fa-lock"
